...
import authReducer, { loginReducer, registrationReducer } from './features/auth/reducer';
...
import authKey, { loginActions, registrationActions } from './features/auth/actions';
import { key as authorizedKey } from './features/layouts/authorized/actions';
import { actionTypes as sharedActionTypes, notificationKey } from './features/shared/actions';
